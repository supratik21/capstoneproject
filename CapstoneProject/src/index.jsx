import ForgeUI, { render, ProjectPage, Fragment, Text, useState, Table, Row, Cell, Head, CustomField, useProductContext } from '@forge/ui';
...
const FieldData = () => {
    const {extensionContext : {filedValue}} = useProductContext();
    let result=""
    for(let i=0; i<filedValue; i++){
        result += "*";
    }
    return (<Text>{result}</Text>);
};
export const  fieldRender = render(
    <CustomField>
        <FieldData/>
    </CustomField>
);